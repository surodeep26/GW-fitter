...
class ScaleableWaveData extends WaveData{
    constructor(datain,mass=2.73,dist=40){
        super(datain);
        this.t0=0;
        this.M0=2.73;
        this.D0=40;
        this.mass=(mass)?mass:2.73;
        this.dist=(dist)?dist:40;
...
WaveFitter.prototype.initData = function(){
    ...
    this.ranges={mass:[1,5],dist:[10,100]} //mass=2.7, dist=40
    ...
    this.data.trange=[-0.7,0.1]; 
    this.data.hrange=[-1.5,1.5]; 
