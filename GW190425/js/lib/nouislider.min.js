...
!function(t) {
    ...
    function m(t, e) {
        ...
        if (e.min === e.max)
            throw new Error("noUiSlider (" + et + "): 'range' 'min' and 'max' cannot be equal.");
    ...
    function v(t, e) {
        if ("boolean" != typeof (t.snap = e))
            throw new Error("noUiSlider (" + et + "): 'snap' option must be a boolean.")
    }
    function b(t, e) {
    ...
    function y(t, e) {
        if (!i(e))
            throw new Error("noUiSlider (" + et + "): 'margin' option must be numeric.");
    ...
    function E(t, e) {
        if (!i(e))
            throw new Error("noUiSlider (" + et + "): 'limit' option must be numeric.");
    ...
    function U(t, e) {
        ...
        if (i) {
            if (2 !== t.handles)
                throw new Error("noUiSlider (" + et + "): 'fixed' behaviour must be used with 2 handles");
    ...
    function L(t, e) {
        if ("object" != typeof e)
            throw new Error("noUiSlider (" + et + "): 'cssClasses' must be an object.");
    ...
    function ut(e) {
        ...
        Object.keys(n).forEach(function(t) {
            if (!s(e[t]) && void 0 === i[t]) {
                if (n[t].r)
                    throw new Error("noUiSlider (" + et + "): '" + t + "' is required.");
                return !0
            }
    ...
    function z(t, f, o) {
            ...
            Object.keys(e).forEach(function(t) {
                !function(t, e, r) {
                    if ((r = i ? i(e, r) : r) !== N) {
                        ...
                        n.style[f.style] = t + "%",
                        U < r && ((n = M(a, !1)).className = p(r, f.cssClasses.value),
        ...
        function L() {
            var t;
            c && ((t = c).parentElement.removeChild(t),
            c = null)
        }
        function z(t) {
            L();
            var m, g, v, b, e, r, S, w, x, n = t.mode, i = t.density || 1, o = t.filter || !1, a = function(t, e, r) {
                ...
                if ("count" === t) {
                    if (e < 2)
                        throw new Error("noUiSlider (" + et + "): 'values' (>= 2) required for mode 'count'.");
                    var n = e - 1
                      , i = 100 / n;
                    for (e = []; n--; )
                        e[n] = n * i;
        ...
        function F(n, i, o, a) {
            var e = function(t) {
                return !!(t = function(t, e, r) {
                    ...
                    t.cursor = a || s,
                    t
                }(t, a.pageOffset, a.target || i)) && (!(y.hasAttribute("disabled") && !a.doNotReject) && (e = y,
                r = f.cssClasses.tap,
        ...
        function H(t) {
            ...
            r ? n.top + a.y - o.clientTop : n.left + a.x - o.clientLeft)) / j();
            return s = it(s),
            f.dir ? 100 - s : s
        }
        function D(t, e) {
        ...
        function R(t, e) {
            e.handle && (st(e.handle, f.cssClasses.active),
            v -= 1),
            e.listeners.forEach(function(t) {
                x.removeEventListener(t[0], t[1])
            }),
            0 === v && (st(y, f.cssClasses.drag),
            J(),
        ...
        function n(t) {
            t.stopPropagation();
            var n, i, o, e = H(t.calcPoint), r = (n = e,
            o = !(i = 100),
        ...
        function Z(t, e) {
            ...
            g.forEach(function(t) {
                ...
                K(t, (e = n[t],
                r = t,
                null === e || !1 === e || void 0 === e ? m[r] : ("number" == typeof e && (e = String(e)),
                e = f.format.from(e),
                !1 === (e = E.toStepping(e)) || isNaN(e) ? m[r] : e)), !0, !1)
            }),
            g.forEach(function(t) {
                K(t, m[t], !0, !0)
            }),
        ...
        return at(e = y, f.cssClasses.target),
    ...
    return {
        ...
        create: function(t, e) {
            if (!t || !t.nodeName)
                throw new Error("noUiSlider (" + et + "): create requires a single element, got: " + t);
            if (t.noUiSlider)
                throw new Error("noUiSlider (" + et + "): Slider was already initialized.");
            var r = z(t, ut(e), e);
